        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/aljumantravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-الجمان/عروض-لندن/عرض-لندن-1.jpg', 'عرض لندن - 6 أيام'],
        image_2: ['عروض-شركة-الجمان/عروض-لندن/عرض-لندن-2.jpg', 'عرض  لندن & اسطنبول - 8 أيام'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-الجمان/عروض-تايلاند/عرض-تايلاند-1.jpg', 'عرض تايلاند - شنغماي & بانكوك'],
    },

    {
        title: 'عروض تركيا',
        image_1: ['عروض-شركة-الجمان/عروض-تركيا/عرض-تركيا-1.jpg', 'عرض تركيا - أسطنبول & بورصة'],
        image_2: ['عروض-شركة-الجمان/عروض-تركيا/عرض-تركيا-2.jpg', 'عرض تركيا - طرابزون & آيدر'],
        image_3: ['عروض-شركة-الجمان/عروض-تركيا/عرض-تركيا-3.jpg', 'عرض أسطنبول - 6 أيام'],
    },

    {
        title: 'عروض سيريلانكا',
        image_1: ['عروض-شركة-الجمان/عروض-سيريلانكا/عرض-سيريلانكا-1.jpg', 'بنتوته - كاندي - نورإيليا'],
    },

    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-الجمان/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'عرض ماليزيا & بوكيت'],
    },

    {
        title: 'عروض فيتنام',
        image_1: ['عروض-شركة-الجمان/عروض-فيتنام/عرض-فيتنام-1.jpg', 'عرض فيتنام & بانكوك'],
    },

    {
        title: 'عروض سنغافورة',
        image_1: ['عروض-شركة-الجمان/عروض-سنغافورة/عرض-سنغافورة-1.jpg', 'عرض سنغافورة - 6 أيام'],
    },

    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-الجمان/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'عرض اذربيجان - باكو & قوبا'],
    },

    {
        title: 'عروض اوزباكستان',
        image_1: ['عروض-شركة-الجمان/عروض-اوزباكستان/عرض-اوزباكستان-1.jpg', 'عرض اوزباكستان - طشقند 6 أيام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966566201496?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/aljumantravel/${encodeURIComponent(src)}`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966566201496";
